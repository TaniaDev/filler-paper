...
Consult the relevant sections of `domain.md` before proposing changes that affect product behavior or domain rules.
...
4. Use the vocabulary defined in `domain.md`.
